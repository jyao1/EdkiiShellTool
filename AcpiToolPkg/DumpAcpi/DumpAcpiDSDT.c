  ...
  )
{
  ...
  EFI_FILE                              *Root;
  EFI_FILE                              *FileHandle;
  CHAR16                                *DsdtFileName = L"Dsdt_%d.aml";
  ...
  Print (         
    L"*****************************************************************************\n"
    L"*         Differentiated System Description Table                           *\n"
    L"*****************************************************************************\n"
    );

  if (GetAcpiDumpPropertyDumpData()) {
    DumpAcpiHex (Dsdt->Length, Dsdt);
  }
  ...
  Print (
    ...
    L"DSDT address ............................................. 0x%016lx\n" :
    L"DSDT address ............................................. 0x%08x\n",
    Dsdt
    );
  
  DumpAcpiTableHeader (Dsdt);
...
Done:
  ...
  FileName[0] = 0;
  UnicodeSPrint (FileName, sizeof(FileName), DsdtFileName, FileIndex);
  
  //
  // Dump DSDT table to Dsdt.aml, use windows AcpiDump.exe to read the information.
  ...
  Root->Close (Root);
  //
  // Dump DSDT to Dsdt.aml finished.
  //
